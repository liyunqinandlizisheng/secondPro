...
- (void)getTgt:(NSString *)tgtUrl andUserName:(NSString *)userName andPassWord:(NSString *)passWord
{
...
//    NSLog(@"nodeContent = %@", nodeContent);
    ...
    if (strFinalTgt)
    {
        [[NSUserDefaults standardUserDefaults] setObject:strFinalTgt forKey:TGT_KEY];

...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self)
    {
        m_IconImgView = [[UIImageView alloc] initWithFrame:CGRectMake(10.0, 15.0, 50.0, 50.0)];
        ...
        m_AutherLbl = [[UILabel alloc] initWithFrame:CGRectMake(70.0, 50.0, 250.0, 20.0)];
        m_AutherLbl.backgroundColor = [UIColor clearColor];
        m_AutherLbl.textColor = [UIColor grayColor];
        [self addSubview:m_AutherLbl];
        
        m_TimeLbl = [[UILabel alloc] initWithFrame:CGRectMake(SCREEN_WIDTH-120, 10.0, 120.0, 20.0)];
